...
> Открыть эту страницу в [https://danilkor.github.io/matrix/](https://danilkor.github.io/matrix/)
...
* найдите **https://github.com/danilkor/matrix** и импортируйте

## Править этот проект ![Значок статуса сборки](https://github.com/danilkor/matrix/workflows/MakeCode/badge.svg)

Редактировать этот репозиторий в MakeCode.

* открыть [https://makecode.microbit.org/](https://makecode.microbit.org/)
* нажмите на **Импорт**, затем **Импорт URL**
* вставьте **https://github.com/danilkor/matrix** и нажмите Импорт
...
![Отрисовка в виде блоков](https://github.com/danilkor/matrix/raw/master/.github/makecode/blocks.png)
